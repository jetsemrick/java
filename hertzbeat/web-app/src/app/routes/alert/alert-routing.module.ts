...
import { IncidentCommandComponent } from './incident-command/incident-command.component';

const routes: Routes = [
  { path: '', component: AlertCenterComponent },
  { path: 'center', component: AlertCenterComponent },
  { path: 'incidents', component: IncidentCommandComponent, data: { titleI18n: 'menu.alert.incidents' } },
