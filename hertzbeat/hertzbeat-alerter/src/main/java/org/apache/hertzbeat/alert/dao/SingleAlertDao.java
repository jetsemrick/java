...
public interface SingleAlertDao extends JpaRepository<SingleAlert, Long>, JpaSpecificationExecutor<SingleAlert> {
    ...
    /**
     * Demo seed cleanup: remove synthetic alarms by fingerprint prefix.
     */
    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("delete from SingleAlert s where s.fingerprint like concat(:prefix, '%')")
    void deleteByFingerprintStartingWith(@Param("prefix") String prefix);
}
